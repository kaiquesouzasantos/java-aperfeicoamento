...
public class TesteWildcard02 {
    ...
    private static void printConsultaAnimal(List<? super Animal> animals){
        // List<? super [superclass]> referenciador -> somente superclass
        animals.add(new Cachorro()); // a super pode adicionar uma subclass, pois garante que a sub é adota o comportamento
